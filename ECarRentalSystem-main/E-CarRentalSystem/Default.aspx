...
&nbsp;&nbsp;
    ...
    &nbsp;
        <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="True" Font-Italic="False" Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/Admin/Add-Car.aspx">Admin</asp:HyperLink>
